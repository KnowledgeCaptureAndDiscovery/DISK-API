...
public class DISK {
    ...
    public static final String HAS_PARENT_HYPOTHESIS = "hasParentHypothesis";
    public static final String HAS_QUESTION = "hasQuestion";
    ...
    public static final String HAS_RELEVANT_VARIABLES = "hasRelevantVariables";
