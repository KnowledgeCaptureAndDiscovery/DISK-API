...
import edu.stanford.bmir.gwtcodemirror.client.NullAutoCompletionHandler;
...
public class GWTCodeMirror extends Composite implements TakesValue<String>, HasValueChangeHandlers<String>, HasEnabled {
    ...
    private List<TextMarker> errorMarkers = new ArrayList<TextMarker>();
    ...
    public void setLineNumbers(boolean b) {
      ...
      setLineNumbers(theCM, b);
  }

  private native void setLineNumbers(JavaScriptObject theCM, boolean b)/*-{
    ...
    public void clearErrorRange() {
        ...
        for(TextMarker errorMarker : errorMarkers)
          errorMarker.clear();
        errorMarkers.clear();
    }
    ...
    public void setErrorRange(EditorPosition start, EditorPosition end) {
        ...
        errorMarkers.add(new TextMarker(mark));
    }
