...
public class HypothesisPresenter extends
    Presenter<HypothesisPresenter.MyView, HypothesisPresenter.MyProxy> {

  @ProxyCodeSplit
  @NameToken(NameTokens.hypotheses)
  public interface MyProxy extends ProxyPlace<HypothesisPresenter> {
  }
  ...
  @Inject
  public HypothesisPresenter(EventBus eventBus, MyView view, MyProxy proxy) {
